...
start_alp_historical_staging_jobs = BashOperator(
    ...
    bash_command='cd /opt/code/enzek-meterpoint-readings/process_ALP && python start_alp_historical_staging_jobs.py',
    dag=dag,
)

start_alp_historical_ref_jobs = BashOperator(
    task_id='start_alp_historical_ref_jobs',
    bash_command='cd /opt/code/enzek-meterpoint-readings/process_ALP && python start_alp_historical_ref_jobs.py',
    dag=dag,
)
