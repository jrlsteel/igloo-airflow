...
process_ensek_occupier_accounts = BashOperator(
    ...
    bash_command='cd /opt/airflow/enzek-meterpoint-readings/process_Ensek/processEnsekOccupierAccounts && python processEnsekOccupierAccounts/process_ensek_occupier_accounts.py',
    dag=dag,
)
...
start_ensek_occupier_accounts_ref_jobs = BashOperator(
    ...
    bash_command='cd /opt/airflow/enzek-meterpoint-readings/process_Ensek/processEnsekOccupierAccounts && python processEnsekOccupierAccounts/start_ensek_occupier_accounts_ref_jobs.py',
    dag=dag,
)
