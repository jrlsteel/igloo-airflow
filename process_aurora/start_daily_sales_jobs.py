...
class DailySalesJobs:
    ...
    def submit_daily_sales_batch_gluejob(self):
        try:
            ...
            #Batch Logging
            util.batch_logging_insert(self.daily_sales_batch_jobid, 60, 'daily_sales_gluejob', 'start_daily_sales_jobs.py')

            obj_daily_sales = glue.ProcessGlueJob(job_name=jobName, s3_bucket=s3_bucket, environment=environment, processJob='daily_sales')
