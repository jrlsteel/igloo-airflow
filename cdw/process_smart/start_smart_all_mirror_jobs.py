...
if __name__ == "__main__":
    ...
    if s.env == "prod":
        ...
        print(
            "{0}: {1} New Prod Env so skipping this step...".format(datetime.now().strftime("%H:%M:%S"), s.process_name)
        )
    else:
        ...
        # # run processing mirror job
        print(
            "Smart All Mirror MeterReads Elec job is running...".format(
        ...
        # # run processing mirror job
        print(
            "Smart All Mirror ProfileData Elec job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        # # run processing mirror job
        print(
            "Smart All Mirror ProfileData Gas job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Smart Temp Stage 2 All Mirror Half Hourly Gas job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        # # run processing mirror job
        print(
            "Smart Temp Stage 2 All Mirror Half Hourly Elec job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
