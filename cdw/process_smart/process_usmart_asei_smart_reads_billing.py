...
class SmartReadsBillings:
    ...
    def __init__(self):
        ...
        self.sql_elec = apif.smart_reads_usmart_asei_billing["elec"]  # there is no need for a weekly run here
        self.sql_gas = apif.smart_reads_usmart_asei_billing["gas"]  # there is no need for a weekly run here
        self.sql_all = apif.smart_reads_usmart_asei_billing["all"]  # there is no need for a weekly run here
...
if __name__ == "__main__":
    ...
    if SmartReadsBillings.get_env() == "uat":
