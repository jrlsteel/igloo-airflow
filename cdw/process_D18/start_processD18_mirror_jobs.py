...
if __name__ == "__main__":
    ...
    util.batch_logging_insert(
        s.process_d18_job_id, 103, "all_process_d18_job", "start_ensek_process_d18_mirror_jobs.py"
    )
    ...
    if s.env == "prod":
        ...
        print(
            "Ensek process d18 Job Mirror  D18 Raw job is running...".format(
        ...
        print(
            "Ensek process d18 Job Mirror  D18 BPP job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek process d18 Job Mirror  D18 PPC job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
