...
class MyTestCase(unittest.TestCase):
    ...
    @patch("cdw.process_verification.verification_template.get_table_count", return_value=10)
    ...
    @patch("cdw.process_verification.verification_template.get_table_count", return_value=0)
    ...
    @patch(
        "cdw.process_verification.verification_template.get_table_column_value", return_value="2021-06-04T02:00:29.962Z"
    )
