...
from cdw.process_Ensek.processEnsekTariffs.process_ensek_tariffs_history import (
    TariffHistory,
...
@unittest.mock.patch(
    "cdw.process_Ensek.processEnsekTariffs.process_ensek_tariffs_history.TariffHistory.get_api_response"
)
@unittest.mock.patch(
    "cdw.process_Ensek.processEnsekTariffs.process_ensek_tariffs_history.TariffHistory.extract_tariff_history_json"
)
...
@mock_s3_deprecated
@unittest.mock.patch("cdw.common.utils.get_accountID_fromDB")
