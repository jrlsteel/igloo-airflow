    ...
    def submit_igloo_calculated_tariffs_gluejob(self):
        try:
            ...
            util.batch_logging_insert(
                self.igloo_calculated_tariffs_jobid,
                52,
                "igloo_calculated_tariffs_gluejob",
                "start_igloo_calculated_tariffs_jobs.py",
            )

            obj_igloo_calculated_tariffs = glue.ProcessGlueJob(
                job_name=jobName, s3_bucket=s3_bucket, environment=environment, processJob="tariff_calc"
            )
            ...
            if igloo_calculated_tariffs_job_response:
                ...
                print(
                    "{0}: Igloo Calculated Tariffs job completed successfully".format(
...
if __name__ == "__main__":
    ...
    util.batch_logging_insert(
        s.all_jobid, 52, "all_igloo_calculated_tariffs_jobs", "start_igloo_calculated_tariffs_jobs.py"
    )
