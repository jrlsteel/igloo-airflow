...
class AccountTransactions:
    ...
    def extract_account_transactions_json(self, data, account_id, k, dir_s3, metrics):
        ...
        column_list = cdw.common.utils.get_common_info("ensek_column_order", "account_transactions")
    ...
    def processAccounts(self, account_ids, k, dir_s3, metrics):
        api_url_template, head = cdw.common.utils.get_ensek_api_info1("account_transactions")
