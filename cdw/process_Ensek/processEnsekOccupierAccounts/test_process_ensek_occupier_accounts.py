...
from cdw.process_Ensek.processEnsekOccupierAccounts.process_ensek_occupier_accounts import OccupierAccounts
...
def test_extract_internal_data_response():
    ...
    dir_s3 = {
        "s3_key": {"OccupierAccounts": "stage2/stage2_OccupierAccounts/"},
    }

    account_transactions.extract_internal_data_response(data, k, dir_s3)
    ...
    assert list(reader) == [
        ["5531", "2017-12-28T00:00:00", "0.0", "1043", "2018-04-03 11:30:00.123456"],
        ["6580", "2018-02-13T00:00:00", "124.54", "996", "2018-04-03 11:30:00.123456"],
        ["6850", "2018-02-23T00:00:00", "0.0", "986", "2018-04-03 11:30:00.123456"],
        [],
    ]
