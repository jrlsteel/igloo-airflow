...
from cdw.process_Ensek import processAllEnsekScripts as ae
...
class StartEnsekJobs:
    ...
    def submit_process_s3_mirror_job(self, source_input, destination_input):
        ...
        try:
            util.batch_logging_insert(
                self.mirror_jobid, 8, "ensek_extract_mirror-" + source_input + "-" + self.env, "start_ensek_api_jobs.py"
            )
    ...
    def submit_Ensek_Gluejob(self):
        try:
            ...
            obj_ensek = glue.ProcessGlueJob(
                job_name=jobname, s3_bucket=s3_bucket, environment=environment, processJob="ensek_non_pa"
            )
...
if __name__ == "__main__":
    ...
    if s.env == "prod":
        ...
        print(
            "Ensek Account Status  Mirror  job is running...".format(
        ...
        print(
            "Ensek Registration Meterpoint Status Elec mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Registration Status  Gas Mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Internal Estimates Elec  mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Internal Estimates Gas  mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Tariff History Mirror  job is running...".format(datetime.now().strftime("%H:%M:%S"), s.process_name)
        )
        ...
        print(
            "Ensek Tariff History Elec Stand Charge Mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Tariff History Gas Stand Charge Mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Tariff History Elec Unit Rates Mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Tariff History Gas Unit Rates Mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Account Transactions mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Account Settings mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
