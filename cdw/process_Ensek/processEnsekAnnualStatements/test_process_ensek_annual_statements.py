...
from cdw.process_Ensek.processEnsekAnnualStatements.process_ensek_annual_statements import AnnualStatements
...
def test_extract_epc_data():
    ...
    expected_s3_key = "stage1/AnnualStatements/annual_statements_{}.csv".format(account_id)
    ...
    assert line1 == [
        "10815",
        "597.0",
        "2020-11-04T15:46:26.034Z",
        "G",
        "2020-11-03T15:46:26.034Z",
        "123456",
        "2020-11-04T15:46:26.034Z",
        "10815",
    ]
