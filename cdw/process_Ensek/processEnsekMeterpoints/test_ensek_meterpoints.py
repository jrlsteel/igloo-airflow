...
from cdw.process_Ensek.processEnsekMeterpoints.process_ensek_meterpoints_no_history import MeterPoints
import statistics
...
@patch("cdw.process_Ensek.processEnsekMeterpoints.process_ensek_meterpoints_no_history.requests.get")
