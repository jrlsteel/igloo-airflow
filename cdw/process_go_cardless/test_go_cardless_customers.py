...
import cdw.process_go_cardless.go_cardless_customers as gcc_module
from cdw.process_go_cardless.go_cardless_customers import GoCardlessCustomers
...
test_customer = {
    "CU001111111111": Customer(
        "CU001111111111", "2020-11-25T13:49:07.255Z", "test.one@gmail.com", "Abbie", "Walker", None, "GB", None
    ),
    "CU002222222222": Customer(
        "CU002222222222", "2020-11-25T13:48:47.149Z", "test2@hotmail.com", "James", "Wilsom", None, "GB", 123456
    ),
    "CU003333333333": Customer(
        "CU003333333333", "2020-11-25T13:45:07.025Z", "testingtesting@yahoo.co.uk", "Fred", "Harris", None, "GB", None
    ),
}
