...
from cdw.connections.connect_db import get_finance_s3_connections as s3_con
...
if __name__ == "__main__":
    ...
    dict_runtime = {1: ["01", "04"], 2: ["04", "07"], 3: ["07", "10"], 4: ["10", "01"]}
    ...
    qtr = math.ceil(date_time_obj.month / 3.0)
    yr = math.ceil(date_time_obj.year)

    ### Derive Report Quarter End
    qtr_rs = math.ceil(ReportEndDate.month / 3.0)
