...
class SmartReadingProcessingJobs:
    ...
    def submit_start_smart_all_reporting_jobs_job(self):
        ...
        try:
            util.batch_logging_insert(self.occupier_accounts_extract_jobid , 51, 'start_smart_all_reporting_jobs', 'start_ensek_occupier_accounts_jobs.py')
...
if __name__ == '__main__':
    ...
    util.batch_logging_insert(s.occupier_accounts_job_id, 51, 'all_occupier_accounts_jobs',
                              'start_smart_all_reporting_jobs_job.py')
