...
from process_smart.process_usmart_asei_smart_reads_billing import SmartReadsBillings
...
class TestSmartReadsBillings(unittest.TestCase):
    ...
    @patch("process_smart.process_usmart_asei_smart_reads_billing.SmartReadsBillings.get_env", mock_airflow_variable)
