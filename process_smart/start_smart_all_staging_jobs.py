...
class ALP:
    ...
    def submit_smart_all_staging_gluejob(self):
        try:
            util.batch_logging_insert(self.alp_cv_staging_jobid, 601, 'smart_all_staging_glue_job','start_smart_all_staging_jobs.py')
...
if __name__ == '__main__':
    ...
    util.batch_logging_insert(s.all_jobid, 600, 'all_alp_jobs', 'start_alp_jobs.py')
