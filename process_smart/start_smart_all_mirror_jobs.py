...
if __name__ == '__main__':
    ...
    if s.env == 'prod':
        ...
        print(
            "Smart All Mirror Inventory job is running...".format(datetime.now().strftime('%H:%M:%S'), s.process_name))
        ...
        # # run processing mirror job
        print("Smart All Mirror MeterReads Elec job is running...".format(datetime.now().strftime('%H:%M:%S'),
                                                                          s.process_name))
        ...
        # # run processing mirror job
        print("Smart All Mirror MeterReads Gas job is running...".format(datetime.now().strftime('%H:%M:%S'),
                                                                         s.process_name))
        ...
        # # run processing mirror job
        print("Smart All Mirror ProfileData Elec job is running...".format(datetime.now().strftime('%H:%M:%S'),
                                                                           s.process_name))
        ...
        # # run processing mirror job
        print("Smart All Mirror ProfileData Gas job is running...".format(datetime.now().strftime('%H:%M:%S'),
                                                                          s.process_name))
        ...
        print("Smart Temp Stage 2 All Mirror Half Hourly Gas job is running...".format(
        ...
        # # run processing mirror job
        print("Smart Temp Stage 2 All Mirror Half Hourly Elec job is running...".format(
            datetime.now().strftime('%H:%M:%S'), s.process_name))
