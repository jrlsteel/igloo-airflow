...
igloo_api = {
    ...
    "api_key": "",
    "aws_access_key": "AKIAYCUAI2SIM6PE3DHU",
    "aws_secret_key": "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",
}
multi_process = {
...
redshift_config = {
    ...
    "user": "igloo",
    "db": "igloo",
    "pwd": "Ie5aeng5iechavaT",
    "port": 5439,
    "secret_id": "redshift/igloowarehouse/igloo",
}
...
test_config = {
    ...
    "enable_db_max": "N",
    "WCFFolders": [
        "Weather Correction Factor, Allocated (EA)",
...
go_cardless = {"access_token": "", "environment": "live"}
