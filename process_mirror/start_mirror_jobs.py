    ...
    def submit_process_s3_mirror_job(self, source_input, destination_input):
        ...
        try:
            util.batch_logging_insert(
                self.mirror_jobid, 60, "s3_mirror-" + source_input + "-" + self.env, "start_mirror_api_jobs.py"
            )
...
if __name__ == "__main__":
    ...
    if s.env == "prod":
        ...
        print(
            "Ensek Meters Attributes mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
        ...
        print(
            "Ensek Readings Internal mirror  job is running...".format(
                datetime.now().strftime("%H:%M:%S"), s.process_name
            )
        )
