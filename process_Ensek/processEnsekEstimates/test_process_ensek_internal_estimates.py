...
def test_extract_internal_data_response_elec():
    ...
    metrics = {}
    internal_estimates.extract_internal_data_response_elec(
        data, account_id, k, dir_s3, metrics)

    expected_s3_key = 'stage1/EstimatesElecInternal/internal_estimates_elec_{}.csv'.format(
        account_id)
    ...
    assert(column_headers == ['EffectiveFrom', 'EffectiveTo', 'EstimationValue',
                              'IsLive', 'MPAN', 'RegisterId', 'SerialNumber', 'account_id'])
    # print(list(reader))
    assert(list(reader) == [
        ['2020-10-21T00:00:00', '9999-12-31T23:59:59.9999999', '7570.0',
            'True', '2700000115580', 'N', 'D10W619612', '100001'],
        ['2020-10-15T00:00:00', '9999-12-31T23:59:59.9999999', '7733.3',
            'True', '2700000115580', 'N', 'D10W619612', '100001'],
        ['2020-09-21T00:00:00', '9999-12-31T23:59:59.9999999', '8324.0',
            'True', '2700000115580', 'N', 'D10W619612', '100001'],
        ['2019-12-19T00:00:00', '9999-12-31T23:59:59.9999999', '3450.9',
            'True', '2700000115580', 'N', 'D10W619612', '100001'],
        ['2019-10-22T00:00:00', '9999-12-31T23:59:59.9999999', '3450.9',
            'True', '2700000115580', 'N', 'D10W619612', '100001'],
...
def test_extract_internal_data_response_gas():
    ...
    metrics = {}
    internal_estimates.extract_internal_data_response_gas(
        data, account_id, k, dir_s3, metrics)

    expected_s3_key = 'stage1/EstimatesGasInternal/internal_estimates_gas_{}.csv'.format(
        account_id)
    ...
    assert(list(reader) == [
        ...
        ['2019-12-19T00:00:00', '9999-12-31T23:59:59.9999999', '10843.0', 'True', '7613419305', 'G', '078247', '100001'],
