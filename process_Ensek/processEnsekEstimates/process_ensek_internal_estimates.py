...
iglog = common.utils.IglooLogger(source="EnsekInternalEstimates")
...
class InternalEstimates:
    ...
    def extract_internal_data_response_elec(self, data, account_id, k, dir_s3, metrics):
        ...
        if (df_internal_readings.empty):
            ...
            column_list = common.utils.get_common_info('ensek_column_order', 'internal_estimates_elec')
    ...
    def extract_internal_data_response_gas(self, data, account_id, k, dir_s3, metrics):
        ...
        if (df_internal_readings.empty):
            ...
            df_internal_readings['account_id'] = account_id
            column_list = common.utils.get_common_info('ensek_column_order', 'internal_estimates_gas')
            df_internal_readings_string = df_internal_readings.to_csv(None, columns=column_list, index=False)
    ...
    def processAccounts(self, account_ids, k, _dir_s3, metrics):
        ...
        api_url, head = common.utils.get_ensek_api_info1('internal_estimates')
        for account_id in account_ids:
            ...
            internal_data_response_elec, internal_data_response_gas = self.get_api_response(api_url1, head, account_id, metrics)
