...
from start_ensek_api_pa_jobs import StartEnsekPAJobs
...
submit_all_ensek_pa_scripts = PythonOperator(
    task_id='submit_all_ensek_pa_scripts',
    provide_context=True,
    python_callable=StartEnsekPAJobs.submit_all_ensek_pa_scripts,
    dag=dag,
)
