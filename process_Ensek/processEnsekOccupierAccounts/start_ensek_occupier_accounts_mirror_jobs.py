...
class StartOccupierAccountsJobs:
    ...
    def submit_process_s3_mirror_job(self, source_input, destination_input):
            ...
            try:
                util.batch_logging_insert(self.occupier_accounts_job_id, 21, 'occupier_account_extract_mirror-' + source_input + '-' + self.env,
                ...
                print(
                    "occupier_account_extract_mirror-" + source_input + "-" + self.env + " files completed in {1:.2f} seconds".format(
