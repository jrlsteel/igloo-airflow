...
class StartOccupierAccountsJobs:
    ...
    def submit_occupier_accounts_extract_reference_gluejob(self):
        try:
            util.batch_logging_insert(
                self.occupier_accounts_reference_jobid,
                51,
                "Occupier Accounts Ref Processing",
                "start_ensek_occupier_accounts_jobs.py",
            )
            ...
            obj_submit_occupier_accounts_status_Gluejob = glue.ProcessGlueJob(
                job_name=jobname, s3_bucket=s3_bucket, environment=environment, processJob="occu_acc"
            )
            ...
            if job_response:
                ...
                print(
                    "{0}: Ensek Occupier Accounts Reference Glue Job completed successfully".format(
...
if __name__ == "__main__":
    ...
    util.batch_logging_insert(
        s.occupier_accounts_job_id, 51, "all_occupier_accounts_jobs", "start_ensek_occupier_accounts_jobs.py"
    )
