...
def test_extract_wcf_data():
    ...
    dir_s3 = {"s3_alp_wcf": {"AlpWCF": "stage1/ALP/AlpWCF/"}}

    start_date = datetime.today().date() - timedelta(days=1)
    end_date = datetime.today().date()

    alp_historical_wcf.extract_wcf_data(data_wcf, wcf_folder, k, dir_s3, start_date, end_date)

    expected_s3_key = "stage1/ALP/AlpWCF/alp_wcf_historical_{}_{}.csv".format(wcf_folder, str(start_date))
