...
class GoCardlessRefunds(object):
    ...
    def process_Refunds(self, _StartDate=None, _EndDate=None):
        ...
        print(".....listing refunds")
        for refund in client.refunds.all(params={"created_at[gte]": StartDate, "created_at[lte]": EndDate}):
            EnsekAccountId = None
            ...
            listRow = [EnsekID, amount, created_at, currency, id, mandate, metadata, payment, reference, status]
            q.put(listRow)
