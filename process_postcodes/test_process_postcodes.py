...
from postcodes_etl import PostcodesETLPipeline
...
valid_csv = {
    ...
    "expected_load_df": pandas.DataFrame(
        [
            ['SW8 1DA', 'SW8  1DA', 'SW8 1DA', '01-1980', 0, 530708, 177089, 1, 'E13000001',
                'Inner London', 'E09000022', 'Lambeth', 'E05000429', 'Stockwell', 'E92000001',
                'England', 'E12000007', 'London', 'E14001008', 'Vauxhall', 'E15000007', 'London',
                'E16000058', 'Lambeth', 'E01003129', 'Lambeth 004E', 'E02000621', 'Lambeth 004',
                '3D2', 'Ethnicity central;Aspirational techies;Established tech workers',
                -0.119236, 51.477668, 'Postcode Level', '08/10/2020', '(51.477668, -0.119236)', 1528193],
            ['L23 1AD', 'L23  1AD', 'L23 1AD', '12-2019', 0, 333815, 401077, 5, 'E11000002',
                'Merseyside', 'E08000014', 'Sefton', 'E05000944', 'Manor', 'E92000001', 'England',
                'E12000002', 'North West', 'E14000916', 'Sefton Central', 'E15000002', 'North West',
                'E16000090', 'Sefton', 'E01007037', 'Sefton 021E', 'E02001449', 'Sefton 021',
                '6B4', 'Suburbanites;Semi-detached suburbia;Older workers and retirement',
                -2.999281, 53.50222, 'Postcode Level', '08/10/2020', '(53.50222, -2.999281)', 807099],
        ],
...
valid_csv_columns_reordered = {
    "response_text": open(os.path.join(os.path.dirname(__file__), 'fixtures', 'test-short-columns-reordered.csv'), 'r').read(),
    "expected_load_df": pandas.DataFrame(
        [
            ['SW8 1DA', 'SW8  1DA', 'SW8 1DA', '01-1980', 0, 530708, 177089, 1, 'E13000001',
                'Inner London', 'E09000022', 'Lambeth', 'E05000429', 'Stockwell', 'E92000001',
...
def test_postcodes_etl_extract_ok(requests_mock, data):
    ...
    requests_mock.get('https://opendata.camden.gov.uk/api/views/tr8t-gqz7/rows.csv?accessType=DOWNLOAD',
...
def test_postcodes_etl_load():
    ...
    s3_bucket = s3_connection.create_bucket(utils.get_dir()["s3_bucket"],)
    ...
    assert(column_headers == ['Postcode 1', 'Postcode 2', 'Postcode 3', 'Date Introduced', 'User Type', 'Easting',
                              'Northing', 'Positional Quality', 'County Code', 'County Name', 'Local Authority Code',
                              'Local Authority Name', 'Ward Code', 'Ward Name', 'Country Code', 'Country Name',
                              'Region Code', 'Region Name', 'Parliamentary Constituency Code', 'Parliamentary Constituency Name',
                              'European Electoral Region Code', 'European Electoral Region Name', 'Primary Care Trust Code',
                              'Primary Care Trust Name', 'Lower Super Output Area Code', 'Lower Super Output Area Name',
                              'Middle Super Output Area Code', 'Middle Super Output Area Name', 'Output Area Classification Code',
                              'Output Area Classification Name', 'Longitude', 'Latitude', 'Spatial Accuracy', 'Last Uploaded',
                              'Location', 'Socrata ID', 'etl_change'])
    assert(list(reader) == [
        ['SW8 1DA', 'SW8  1DA', 'SW8 1DA', '01-1980', '0', '530708', '177089', '1', 'E13000001', 'Inner London',
         'E09000022', 'Lambeth', 'E05000429', 'Stockwell', 'E92000001', 'England', 'E12000007', 'London', 'E14001008',
         'Vauxhall', 'E15000007', 'London', 'E16000058', 'Lambeth', 'E01003129', 'Lambeth 004E', 'E02000621',
         'Lambeth 004', '3D2', 'Ethnicity central;Aspirational techies;Established tech workers', '-0.119236',
         '51.477668', 'Postcode Level', '08/10/2020', '(51.477668, -0.119236)', '1528193', '2018-04-03 11:19:00.123456'],
        ['L23 1AD', 'L23  1AD', 'L23 1AD', '12-2019', '0', '333815', '401077', '5', 'E11000002', 'Merseyside',
         'E08000014', 'Sefton', 'E05000944', 'Manor', 'E92000001', 'England', 'E12000002', 'North West', 'E14000916',
         'Sefton Central', 'E15000002', 'North West', 'E16000090', 'Sefton', 'E01007037', 'Sefton 021E', 'E02001449',
         'Sefton 021', '6B4', 'Suburbanites;Semi-detached suburbia;Older workers and retirement', '-2.999281',
         '53.50222', 'Postcode Level', '08/10/2020', '(53.50222, -2.999281)', '807099', '2018-04-03 11:19:00.123456'],
        []
    ])
