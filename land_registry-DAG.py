...
process_land_registry = BashOperator(
    ...
    bash_command='cd /usr/local/airflow/dags/enzek-meterpoint-readings && ../.venv/bin/python process_LandRegistry/process_land_registry.py',
    dag=dag,
)

start_land_registry_staging_jobs = BashOperator(
    task_id='start_land_registry_staging_jobs',
    bash_command='cd /usr/local/airflow/dags/enzek-meterpoint-readings && ../.venv/bin/python process_LandRegistry/start_land_registry_staging_jobs.py',
    dag=dag,
)
